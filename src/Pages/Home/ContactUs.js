...
const ContactUs = () => {
    ...
    return (
        <div className=''>
            <h2 className='text-3xl bg-secondary rounded text-white p-2 text-center my-10'>Contact with Us  </h2>
            <form class="w-full max-w-lg text-center">
                ...
                <div class="md:flex md:items-center">
                    <div class="md:w-1/3">
                        <button onClick={handleContact} class="shadow bg-teal-400 hover:bg-teal-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button">
                            Send
                        </button>
                    </div>
